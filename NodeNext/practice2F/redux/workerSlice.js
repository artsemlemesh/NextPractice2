...
export const addWorker = createAsyncThunk('workers/addWorker', async (newWorker) => {
    const res = await fetch('http://localhost:3001/workers', {
...
export const updateWorker = createAsyncThunk('workers/updateWorker', async (updatedWorker) => {
    const res = await fetch(`http://localhost:3001/workers/${updatedWorker._id}`, {
        method: 'PUT',
        headers: {
...
export const deleteWorker = createAsyncThunk('workers/deleteWorker', async (_id) => {
